document.addEventListener('DOMContentLoaded', function() {
    ...
    const points = {
        'Signing of the Magna Carta': [20, 12, 8, 6, 4, 3, 2, 0],
        'Columbus Discovers America': [16, 16, 11, 7, 5, 4, 2, 1],
        'American Declaration of Independence': [12, 12, 14, 9, 7, 5, 3, 2],
        'French Revolution': [10, 10, 11, 12, 8, 6, 4, 4],
        'Assassination of Archduke Franz Ferdinand': [8, 8, 8, 9, 11, 8, 5, 5],
        'End of World War II': [6, 6, 7, 7, 8, 10, 7, 5],
        'Moon Landing': [5, 5, 5, 6, 7, 9, 9, 7],
        'Fall of the Berlin Wall': [4, 4, 4, 4, 5, 6, 7, 8]
    };

    const correctOrder = [
        { city: 'Signing of the Magna Carta', year: '1215' },
        { city: 'Columbus Discovers America', year: '1492' },
        { city: 'American Declaration of Independence', year: '1776' },
        { city: 'French Revolution', year: '1789' },
        { city: 'Assassination of Archduke Franz Ferdinand', year: '1914' },
        { city: 'End of World War II', year: '1945' },
        { city: 'Moon Landing', year: '1969' },
        { city: 'Fall of the Berlin Wall', year: '1989' }
    ];
